...
![Status Badge](https://img.shields.io/badge/Status-Completado-success)
...
4.  Crear un sistema de reportes que muestre resúmenes de progreso y estadísticas.
5.  Aplicar conocimientos de la librería `datetime` para la gestión eficiente de fechas y tiempos.
...
```bash
git clone [https://github.com/TuUsuario/StudyBonaventuriano.git](https://github.com/TuUsuario/StudyBonaventuriano.git)
cd StudyBonaventuriano
